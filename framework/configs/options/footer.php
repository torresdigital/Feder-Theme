 ...
 * @return array
 */
function lapa_options_section_footer( $sections )
{
    $sections['footer'] = array(
        'name'          => 'footer_panel',
        'title'         => esc_html_x('Footer', 'admin-view', 'torresdigital'),
        ...
        'sections' => array(
            array(
                ...
                'fields'    => array(
                    array(
                        ...
                        'type'      => 'image_select',
                        'default'   => '1col',
                        'title'     => esc_html_x('Footer Layout', 'admin-view', 'torresdigital'),
                        'radio'     => true,
                        'options'   => Lapa_Options::get_config_footer_layout_opts()
                    ),
                    array(
                        ...
                        'default'   => 'no',
                        'title'     => esc_html_x('100% Footer Width', 'admin-view', 'torresdigital'),
                        'desc'      => esc_html_x('Turn on to have the footer area display at 100% width according to the window size. Turn off to follow site width.', 'admin-view', 'torresdigital'),
                    ...
                    array(
                        ...
                        'class'     => 'la-radio-style',
                        'default'   => 'yes',
                        'title'     => esc_html_x('Enable Footer Copyright', 'admin-view', 'torresdigital'),
                        'options'   => Lapa_Options::get_config_radio_opts(false)
                    ),
                    array(
                        'id'        => 'footer_copyright',
                        ...
                        'title'     => esc_html_x('Footer Copyright', 'admin-view', 'torresdigital'),
            ...
            array(
                ...
                'title'     => esc_html_x('Footer Styling', 'admin-view', 'torresdigital'),
                ...
                'fields'    => array(
                    array(
                        ...
                        'desc'      => esc_html_x('For footer', 'admin-view', 'torresdigital')
                    ),
                    array(
                        'id'        => 'footer_space',
                        'type'      => 'canvas',
                        ...
                        'title'     => esc_html_x('Footer Space', 'admin-view', 'torresdigital'),
                        'desc'      => esc_html_x('For footer', 'admin-view', 'torresdigital')
                    ),
                    array(
            ...
            array(
                ...
                'title'     => esc_html_x('Footer Copyright Styling', 'admin-view', 'torresdigital'),
                'icon'      => 'fa fa-paint-brush',
                'fields'    => array(
                    array(
                        ...
                        'desc'      => esc_html_x('For Footer Copyright', 'admin-view', 'torresdigital')
                    ),
                    array(
